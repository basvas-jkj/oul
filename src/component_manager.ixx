...
/// @return <code>true</code>, pokud se položka nachází mimo složku komponenty, jinak  <code>false</code>
...
namespace oul
{
    ...
    export class COMPONENT_MANAGER
    {
        ...
        /// @param component_path - cesta ke komponentě relativní vzhledem k umístění konfiguračního souboru
