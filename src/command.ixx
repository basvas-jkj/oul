...
namespace oul
{
    ...
    public:
        ...
        /// @return <code>true</code>, pokud byl program spuštěn s daným přepínačem, jinak <code>false</code>
        ...
        /// @param name - jméno dotazovaného přepínače
        /// @return hodnotu argumentu, pokud byl program spuštěn s daným přepínačem, jinak prázdný řetezec
    ...
    protected:
        ...
        /// @brief Načte konfiguraci a vytvoří objekt typu <code>COMPONENT_MANAGER</code>, který spravuje nalezenou konfiguraci.
